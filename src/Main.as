...
namespace TmMcpPackEpp {
    ...
    void RegisterPack() {
        ...
        Add(b, "PlaceBlock", "E++ PlaceBlocks freeblock. blockName,x,y,z; optional pitch/yaw/roll/variant/addUndo/autofocus/tag.", '{"type":"object","properties":{"blockName":{"type":"string"},"x":{"type":"number"},"y":{"type":"number"},"z":{"type":"number"},"pitch":{"type":"number"},"yaw":{"type":"number"},"roll":{"type":"number"},"variant":{"type":"integer"},"addUndo":{"type":"boolean"},"autofocus":{"type":"boolean"},"tag":{"type":"string"}},"required":["blockName","x","y","z"],"additionalProperties":false}');
